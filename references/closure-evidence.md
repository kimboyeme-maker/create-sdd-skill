...
Read this reference only for implementation-completeness or closure audits, or when the repository explicitly requires quantitative acceptance metrics.
