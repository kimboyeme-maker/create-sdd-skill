...
`validate-draft` performs the same design checks before a file is written. Neither command proves implementation, semantic completeness, agent reading, or permission enforcement.

<!-- reading-receipt: 33308c4e -->
