...
## Requirements
- R1 Stages of every mode (`sync`, `async`, `generator`, `async-generator`) observe `featureA()` cancellation.
...
| mode | observes cancellation | source |
| --- | --- | --- |
| sync | yes | USER_STATED |
| async | yes | USER_STATED |
| generator | yes | USER_STATED |
| async-generator | yes | OBSERVED |
