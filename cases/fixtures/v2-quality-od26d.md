...
Review sdd/v2 fixture for the acceptance-quality cases (OD-15..OD-28). Each `v2-quality-od*.md`
...
- R4 The settings page must never show an empty label.
...
- A7 Given a plugin with no label, when the settings page renders, then its row shows the plugin name.
...
```json
{
  ...
  "requirements": [
    ...
    { "id": "R4", "kind": "must-ship", "implementation": ["S3"], "acceptance": ["A7"] }
  ],
  "batches": [
    { "id": "C1", "steps": ["S1", "S2", "S3"], "requirements": ["R1", "R2", "R3", "R4"], "depends_on": [] }
  ],
  "steps": ["S1", "S2", "S3"],
  "step_sources": [],
  ...
  "metas": [
    { "id": "E1", "kind": "Entry", "members": ["M1", "M2", "M3", "M4"] },
    ...
    { "id": "M4", "kind": "Module", "owner": "self", "source_id": "R4", "origin": { "document": "self", "requirement_id": "R4" } },
    { "id": "K1", "kind": "Chunk", "owner": "self", "source_id": "C1", "members": ["M1", "M2", "M3", "M4"] },
    { "id": "B1", "kind": "Bundle", "owner": "self", "members": ["K1"], "requires": [] },
    { "id": "T1", "kind": "Asset", "producer": "B1", "path": "packages/feature-a/src/index.ts", "version": "1", "acceptance": ["A1", "A2", "A3", "A4", "A5", "A6", "A7"] }
  ],
  "exports": [],
  "consumes": [],
